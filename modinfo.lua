...
return {
		...
		game = "Evolution RTS Shard LuaAI",
		shortGame = "evortsshardluaai",
		name = "Evolution RTS Shard LuaAI",
		shortName = "evortsshardluaai",
		version = "$VERSION",
		mutator = "Official",
		-- These can be shown by the selection interface
		description = "This is a support archive containing the Taskqueues for Evolution RTS for Shard Lua AI for Spring.",
